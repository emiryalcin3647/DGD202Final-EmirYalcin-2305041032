...
public class PelletSpawner : MonoBehaviour
{
    ...
    public void SpawnPellets()
    {
        ...
        Debug.Log("Pellets Spawned Obje adý: " + gameObject.name);
    ...
    private void SpawnPellet(Vector2 position)
    {
        ...
        Instantiate(_pelletPrefab, worldPosition, Quaternion.identity);
    }
    ...
    private bool NearAnotherPellet(Vector2 pelletPosition)
    {
        ...
        {
            if ((pelletPosition - _pelletPositions[i]).magnitude < _detectionRadius)
                return true;
        }
